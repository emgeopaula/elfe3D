   ...
   subroutine write_vtk_fields (M, refStep, MeshFileName, &
    ...
    !--------------------------------------------------------------------
     ...
     if (opening /= 0) then
        ...
        do mi = 1,M
            write(999,*) datan2d(aimag(domain_Efields(mi,2)), &
                                  real(domain_Efields(mi,2)))
        end do
        ...
        do mi = 1,M
            write(999,*) datan2d(aimag(domain_Efields(mi,3)), &
                                  real(domain_Efields(mi,3)))
        end do
        ...
        do mi = 1,M
            write(999,*) datan2d(aimag(domain_Hfields(mi,1)), &
                                  real(domain_Hfields(mi,1)))
        end do
        ...
        do mi = 1,M
            write(999,*) datan2d(aimag(domain_Hfields(mi,2)), &
                                  real(domain_Hfields(mi,2)))
        end do
        ...
        do mi = 1,M
            write(999,*) datan2d(aimag(domain_Hfields(mi,3)), &
                                  real(domain_Hfields(mi,3)))
        end do
